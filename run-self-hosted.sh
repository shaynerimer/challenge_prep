...
tmux send-keys -t "$SESSION_NAME:0.0" "dapr run --app-id order-processor --app-port 3010 --resources-path ./deploy/dapr_components/ -- node ./order_processor/order_processor.js" C-m
